  ...
  <div class="row">
    ...
    <div class="col-12 mb-4">
      ...
      <p class="text-muted small mb-0">
        ...
        Configurez l'architecture des diplômes, associez les matières aux UE et définissez les coefficients, ECTS et notes éliminatoires.
      </p>
    </div>
      ...
      <div class="card border-0 shadow-sm rounded-4 bg-white">
        <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
          <h5 class="fw-bold text-dark mb-0">
            <i class="bi bi-gear-wide-connected text-primary me-2"></i>{{ isEditing ? 'Modifier la Règle Académique' : 'Paramétrer une Matière / Élément Constitutif (EC)' }}
          </h5>
        </div>
        <div class="card-body p-4">
          <form @submit.prevent="saveProgramRule">
            <div class="row g-3">
              <!-- Classe / Parcours -->
              <div class="col-md-3">
                <label class="form-label small fw-semibold text-muted mb-1">Classe / Spécialité</label>
              ...
              <div class="col-md-2">
                ...
                <select class="form-select bg-light border-0 shadow-sm" v-model="form.semestre" required>
              ...
              <div class="col-md-3">
                ...
                <select class="form-select bg-light border-0 shadow-sm" v-model="form.moduleCode" required>
              ...
              <!-- Nom de la Matière -->
              <div class="col-md-4">
                <label class="form-label small fw-semibold text-muted mb-1">Intitulé de la Matière (EC)</label>
                <input 
                  type="text" 
              ...
              <div class="col-md-3">
                <label class="form-label small fw-semibold text-muted mb-1">Coefficient de la matière</label>
                <input 
                  type="number" 
                  class="form-control bg-light border-0 shadow-sm" 
                  placeholder="Ex: 2" 
              ...
              <div class="col-md-3">
                <label class="form-label small fw-semibold text-muted mb-1">Crédits ECTS attribués</label>
                <input 
                  type="number" 
                  class="form-control bg-light border-0 shadow-sm" 
                  placeholder="Ex: 4" 
              ...
              <div class="col-md-4">
                <label class="form-label small fw-semibold text-muted mb-1">Note éliminatoire sur 20</label>
    ...
    <div class="col-12">
      <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white">
        <div class="card-header bg-white border-0 pt-4 px-4 pb-2 d-flex justify-content-between align-items-center">
          ...
          <!-- Filtrage par Classe -->
          <select class="form-select form-select-sm border shadow-sm w-25" v-model="tableFilterClasse">
              ...
              <tbody>
                <tr v-for="rule in filteredRules" :key="rule.id" class="transition-all">
                  ...
                  <td class="text-center">
                    <span class="badge bg-soft-success text-success px-3 py-1 rounded-pill fw-bold" style="font-size: 11px;">
                      {{ rule.ects }} ECTS
                    </span>
                  </td>
                  ...
                  <!-- Note Éliminatoire -->
                  <td class="text-center">
                    <span v-if="rule.noteEliminatoire" class="badge bg-soft-danger text-danger px-2 py-1 fw-bold">
                  ...
                  <td class="text-end pe-4">
                    ...
                    <button class="btn btn-link text-danger p-0 border-0" @click="deleteRule(rule.id)">
                ...
                <tr v-if="filteredRules.length === 0">
                  <td colspan="7" class="text-center py-5">
                    ...
                    <p class="small text-muted mb-0">Remplissez le formulaire ci-dessus pour ajouter des coefficients et des crédits.</p>
                  </td>
                </tr>
              </tbody>
            </table>
...
const mockRules = ref([
  { id: 1, classe: 'Master 1 Info', semestre: 'Semestre 1', moduleCode: 'UE-INF-1', matiere: 'Conception orientée objet & Patterns', coefficient: 2, ects: 4, noteEliminatoire: 8 },
  { id: 2, classe: 'Master 1 Info', semestre: 'Semestre 1', moduleCode: 'UE-INF-1', matiere: 'Frameworks Modernes (Vue.js 3 & Node)', coefficient: 2, ects: 4, noteEliminatoire: null },
  { id: 3, classe: 'Master 2 Info', semestre: 'Semestre 1', moduleCode: 'UE-DATA-2', matiere: 'Deep Learning & Vision par ordinateur', coefficient: 3, ects: 6, noteEliminatoire: 10 }
]);
...
const resetForm = () => {
  ...
  form.value = { classe: '', semestre: 'Semestre 1', moduleCode: '', matiere: '', coefficient: null, ects: null, noteEliminatoire: null };
};
