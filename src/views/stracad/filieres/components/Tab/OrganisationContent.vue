...
// Récupération réactive des données et du loading depuis le store
const loading = computed(() => filiereStore.loading);
const organisationFilieres = computed(() => filiereStore.organisationTree || []);
...
onMounted(async () => {
  await filiereStore.fetchFiliereOrganisation();
});
</script>
