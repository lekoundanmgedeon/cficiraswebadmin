          ...
          <div class="modal-body">
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex justify-content-between">
                ...
                <span>{{
                  item.filiere_nom || item.filiere_designation || item.filiere_code || '-'
                }}</span>
              </li>
              <li class="list-group-item d-flex justify-content-between">
                <strong>Niveau :</strong>
                <span>{{
                  item.niveau_code || item.niveau_nom || item.niveau_designation || '-'
                }}</span>
              </li>
              <li class="list-group-item d-flex justify-content-between">
              ...
              <li class="list-group-item d-flex justify-content-between">
                ...
                <span>{{
                  formatDate(item.created_at || item.date_creation || item.createdAt)
                }}</span>
              </li>
              <li class="list-group-item d-flex justify-content-between">
