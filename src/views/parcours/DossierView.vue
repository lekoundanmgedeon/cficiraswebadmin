              ...
              <div class="row">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      ...
                      <p class="text-muted small mb-0">
                        Recherchez un étudiant et consultez son parcours, ses notes et son
                  ...
                  <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0 py-3">
                      <h6 class="mb-0 fw-bold">
                        <i class="mdi mdi-filter-variant me-2 text-primary"></i>Filtrer les
                        étudiants
                      </h6>
                    </div>
                ...
                <div class="col-12">
                  <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0 py-3">
                      <h6 class="mb-0 fw-bold">
                        <i class="mdi mdi-account-list-outline me-2 text-primary"></i>Registre des
                        étudiants
                      </h6>
                    </div>
                          ...
                          <tbody>
                            <tr v-for="etudiant in filteredEtudiants" :key="etudiant.id">
                              ...
                              <td class="text-end pe-4">
                                <RouterLink
                                  :to="`/dossiers-scolaires/${etudiant.id}/global-informations`"
...
<script setup>
import DossierHeader from './components/HeaderView.vue';
...
const etudiants = ref([
  ...
  {
    id: 3,
    matricule: 'ETU-2025-045',
    nom: 'NFAH',
    prenom: 'Jean',
    email: 'jean.nfah@univ.sn',
    annee: '2024-2025',
    filiere: 'Informatique',
    niveau: 'Licence 1',
    classe: 'INF-L1-A',
