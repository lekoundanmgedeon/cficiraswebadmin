          ...
          <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body p-4" v-if="inscription">
              <div class="text-center mb-4">
                <div class="avatar-container bg-soft-primary rounded-circle mx-auto mb-2 d-flex align-items-center justify-content-center" style="width: 65px; height: 65px;">
              ...
              <ul class="list-group list-group-flush border-top border-bottom">
                <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
                  ...
                  <span class="fw-semibold text-dark">{{ formatSexe(inscription.etudiant_sexe || inscription.sexe) }}</span>
                </li>

                <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
                  <span class="text-muted small-title">Classe</span>
                  <span class="badge bg-soft-info text-info fw-bold font-monospace px-3 py-2 rounded">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
                  ...
                  <span class="badge rounded-pill px-3 py-2 fw-semibold" :class="statutClass(inscription.inscription_statut || inscription.statut)">
            ...
            <div class="modal-footer bg-light border-0 px-4 py-3">
              <button type="button" class="btn btn-secondary rounded-pill px-4 shadow-sm" @click="close">
                Fermer
              </button>
            </div>
          </div>
