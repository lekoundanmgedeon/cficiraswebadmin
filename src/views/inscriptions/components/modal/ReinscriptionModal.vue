        ...
        <div class="modal-body position-relative p-4">
          ...
          >
            ...
            <p class="text-muted" style="font-size: 0.75rem">
              Veuillez patienter pendant la mise à jour des parcours administratifs.
            </p>
          </div>
          ...
          <div v-if="!importReport">
            <div class="row g-3 align-items-center mb-3 bg-light p-3 rounded border">
              <div class="col-md-6">
                <label class="form-label fw-bold text-secondary style-label mb-1"
                  >Nouvelle Année Académique *</label
                >
            ...
            <div
              ...
              :class="{
                'border-info bg-info bg-opacity-10': isDragging,
            ...
            >
              ...
              <div v-if="!selectedFile">
                ...
                <p class="fw-bold mt-2 mb-1 small">
                  Glissez-déposez le fichier de réinscription ici
                </p>
            ...
            >
              ...
              <div>
                Des incohérences de format ont été détectées. Veuillez corriger le fichier avant
                l'envoi.
              </div>
            </div>
            ...
            <div v-if="previewData.length" class="mt-4 animate-fade-in">
              <div class="d-flex justify-content-between align-items-center mb-2">
                <h6 class="fw-bold text-dark mb-0 style-title">
                  <i class="bi bi-eye-fill me-1 text-muted"></i> Aperçu des réinscriptions
                      ...
                      <td class="text-end pe-3">
                        ...
                        <div v-else>
                          ...
                          <div
                            ...
                            style="font-size: 0.65rem; max-width: 180px"
                          >
                ...
                >
                  ...
                  <tbody>
                    <tr v-for="(err, idx) in importReport.details.echecs" :key="idx">
                      ...
                      <td class="fw-semibold text-nowrap font-monospace">
                        {{ err.etudiant || err.matricule }}
                      </td>
