          ...
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <small class="text-muted text-xs"
                >Extraction consolidée des données du tableau de bord</small
              >
            </div>
          </div>
          <button
        ...
        <div class="modal-body p-4">
          <form @submit.prevent="traiterExtraction">
            ...
            <div class="row g-2 mb-3">
              <div class="col-md-6">
                ...
                <input
                  ...
                  class="form-control text-xs shadow-none bg-light border"
                  required
                />
              </div>
              <div class="col-md-6">
              ...
              <div class="d-flex gap-3">
                <div class="form-check flex-fill p-2 bg-white rounded border text-center">
                  ...
                  <label
                    ...
                    for="formatPdf"
                  >
                    <i class="bi bi-file-earmark-pdf-fill fs-5 d-block mb-1 text-danger"></i>
                    Document PDF (.pdf)
                  </label>
                </div>
                <div class="form-check flex-fill p-2 bg-white rounded border text-center">
                  ...
                  <label
                    ...
                    for="formatExcel"
                  >
                    <i class="bi bi-file-earmark-excel-fill fs-5 d-block mb-1 text-success"></i>
                    Tableur Excel (.xlsx)
                  </label>
                </div>
              </div>
            ...
            <div class="d-flex gap-2 justify-content-end pt-2 border-top border-light">
              <button
                type="button"
                class="btn btn-sm btn-light border text-xs px-3"
                data-bs-dismiss="modal"
              >
                Annuler
              </button>
