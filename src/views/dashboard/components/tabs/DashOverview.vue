    ...
    <div class="row g-3 mb-4">
      ...
      <div class="col-md-3">
        <div class="card bg-white border-0 shadow-sm p-3 border-start border-success border-3 rounded-4">
          <span class="text-muted small fw-semibold text-uppercase d-block mb-1">Fonds Encaissés</span>
      ...
      <div class="col-md-3">
        <div class="card bg-white border-0 shadow-sm p-3 border-start border-warning border-3 rounded-4">
          <span class="text-muted small fw-semibold text-uppercase d-block mb-1">Restes à Recouvrer</span>
      ...
      <div class="col-md-3">
        <div class="card bg-white border-0 shadow-sm p-3 border-start border-primary border-3 rounded-4">
          <span class="text-muted small fw-semibold text-uppercase d-block mb-1">Effectif Étudiants</span>
      ...
      <div class="col-md-3">
        <div class="card bg-white border-0 shadow-sm p-3 border-start border-danger border-3 rounded-4">
          <span class="text-muted small fw-semibold text-uppercase d-block mb-1">Charges de Vacation</span>
      ...
      <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 bg-white p-4 h-100">
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <span class="badge bg-light text-secondary border font-monospace text-xs">Année Académique 2025-2026</span>
          </div>
      ...
      <div class="col-lg-4">
        <div class="card border-0 shadow-sm rounded-4 bg-white p-4 h-100 d-flex flex-column">
          ...
          <div class="flex-grow-1">
            <!-- Alerte 1 -->
            <div class="p-2 bg-soft-warning rounded text-xs mb-2 border-start border-3 border-warning">
              <span class="fw-bold text-dark d-block mb-1">Alerte Échéancier critique</span>
              La filière <strong class="text-warning">Sciences Juridiques (L2-A)</strong> présente un taux d'impayés de 55% sur la traite de mai. Une campagne de relance SMS est préconisée.
            </div>
            
            <!-- Alerte 2 -->
            <div class="p-2 bg-soft-success rounded text-xs mb-2 border-start border-3 border-success">
              <span class="fw-bold text-dark d-block mb-1">Seuil de Rentabilité Atteint</span>
              Le pôle <strong class="text-success">Management & Masters</strong> a entièrement couvert ses charges fixes trimestrielles à la date du 15 mai.
            </div>
            ...
            <div class="p-2 bg-soft-danger rounded text-xs border-start border-3 border-danger">
              ...
              La simulation budgétaire montre qu'une hausse de 5% du taux des vacations dégraderait la marge opérationnelle de 1.6%.
            </div>
          </div>

          <div class="pt-3 border-top border-light mt-3 text-center">
            <button class="btn btn-xs btn-outline-primary border-0 font-semibold p-0 w-100 small text-xs">
