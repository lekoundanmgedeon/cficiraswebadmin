    ...
    <div class="row g-3 mb-4">
      ...
      <div class="col-md-4">
        <div class="card bg-white border-0 shadow-sm p-3 border-start border-primary border-3 rounded-4">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <span class="text-muted small fw-semibold text-uppercase d-block mb-1">Cycle Licence</span>
            ...
            <span class="badge bg-soft-primary text-primary rounded-pill font-monospace fw-bold">L1-L3</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card bg-white border-0 shadow-sm p-3 border-start border-warning border-3 rounded-4">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <span class="text-muted small fw-semibold text-uppercase d-block mb-1">Cycle Master</span>
            ...
            <span class="badge bg-soft-warning text-warning rounded-pill font-monospace fw-bold">M1-M2</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card bg-white border-0 shadow-sm p-3 border-start border-success border-3 rounded-4">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <span class="text-muted small fw-semibold text-uppercase d-block mb-1">Certifications & Pro</span>
            ...
            <span class="badge bg-soft-success text-success rounded-pill font-monospace fw-bold">Certif</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-7">
        <div class="card border-0 shadow-sm rounded-4 bg-white p-4 h-100">
          <h6 class="fw-bold text-dark mb-3 small text-uppercase text-secondary tracking-wider">
            <i class="bi bi-funnel-fill text-warning me-2"></i>Pyramide des Effectifs par Niveau (Cohortes)
          </h6>
      ...
      <div class="col-lg-5">
        <div class="card border-0 shadow-sm rounded-4 bg-white p-4 h-100 d-flex flex-column">
          ...
          <div class="flex-grow-1">
            ...
            <div class="mb-3">
              <div class="d-flex justify-content-between text-xs mb-1">
                <span class="fw-semibold text-muted">Fidélisation Cycle Interne (Licence ➔ Master)</span>
          ...
          <div class="p-3 bg-light rounded text-xs text-muted border-start border-3 border-primary mt-auto">
            <span class="fw-bold text-dark d-block mb-1"><i class="bi bi-info-circle me-1"></i>Note Secrétariat :</span>
            Le taux de rétention L1-L2 a progressé de +3.4% cette année grâce au déploiement anticipé du module de suivi des émargements et présences.
          </div>
        </div>
      </div>
    </div>
