          ...
          <div class="d-flex align-items-end flex-wrap">
            <div class="me-md-3 me-xl-5">
              ...
              <p class="text-muted small mb-0">
                Attributions et suivi des notes de contrôles continus et examens
              </p>
            </div>
          ...
          <div class="d-flex justify-content-between align-items-end flex-wrap gap-2">
            ...
            <div class="btn-group shadow-sm">
              ...
              <ul class="dropdown-menu shadow-sm">
                <li>
                  <a class="dropdown-item" href="#" @click.prevent="triggerImport('CSV')"
                    >Importer un fichier CSV</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="#" @click.prevent="triggerImport('EXCEL')"
                    >Importer un fichier Excel</a
                  >
                </li>
              </ul>
            </div>
    ...
    <div class="row mb-4" v-if="activeTab !== 'overview'">
      <div class="col-12">
        <div class="card border-0 shadow-sm bg-light">
          <div
            class="card-body p-3 d-flex flex-wrap justify-content-between align-items-center gap-3"
          >
            <div class="btn-group shadow-sm bg-white rounded p-1" role="group">
              <button
                ...
                :key="semestre"
                :class="[
                  'btn btn-sm rounded px-4',
                  selectedSemestre === semestre ? 'btn-primary' : 'btn-white border-0 text-muted',
                ]"
            ...
            <ul class="nav nav-tabs px-4 pt-3 bg-light" role="tablist">
              ...
              <li class="nav-item">
                <a
                  ...
                  data-bs-toggle="tab"
                  href="#evaluations-list"
                  @click="activeTab = 'SESSION_ORDINAIRE'"
                >
                  🎓 Sessions Ordinaires
                </a>
              </li>
                  ...
                  <table class="table table-hover align-middle">
                    ...
                    <tbody>
                      <tr v-for="classe in filteredClasses" :key="classe.classe_id">
                        ...
                        <td class="text-center">
                          <span class="badge bg-soft-warning text-dark rounded-pill px-3 py-2"
                            >En cours</span
                          >
                        </td>
                        <td class="text-center">
                          <span class="badge bg-soft-danger text-white rounded-pill px-3 py-2"
                            >En attente</span
                          >
                        </td>
                      </tr>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <div>
                    <h4 class="fw-bold text-dark mb-0">
                      Classes & Parcours — {{ currentTabLabel }}
                    </h4>
                            ...
                            <ul class="dropdown-menu shadow-sm dropdown-menu-end">
                              <li>
                                <a
                                  class="dropdown-item"
                                  href="#"
                                  @click.prevent="consulterNotes(classe)"
                                  >Voir les notes</a
                                >
                              </li>
                              <li>
                                <a
                                  class="dropdown-item"
                                  href="#"
                                  @click.prevent="ouvrirSaisieRapide(classe)"
