    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div>
        <h5 class="fw-bold text-secondary mb-0">
          <i class="bi bi-journal-text me-2"></i>Liste des Classes — {{ currentTabLabel }}
        </h5>
        ...
        <tbody>
                ...
                <ul class="dropdown-menu shadow-sm dropdown-menu-end">
                  <li>
                    <a class="dropdown-item" href="#" @click.prevent="consulterNotes(classe)">
                      <i class="bi bi-eye me-2 text-muted"></i>Voir les notes
                    </a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="#" @click.prevent="ouvrirSaisieRapide(classe)">
                      <i class="bi bi-pencil me-2 text-muted"></i>Modifier les saisies
                    </a>
                  </li>
                  <li><hr class="dropdown-divider" /></li>
                  <li>
                    <a class="dropdown-item text-success" href="#" @click.prevent="validerNotesSession(classe)">
                      <i class="bi bi-lock-fill me-2"></i>Valider définitivement
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <tr v-if="filteredClasses.length === 0">
            <td colspan="6" class="text-center py-5">
              ...
              <p class="text-muted mb-0">Aucune classe ne correspond à votre recherche.</p>
            </td>
          </tr>
        </tbody>
      </table>
