    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div>
        <h5 class="fw-bold text-secondary mb-0">
          <i class="bi bi-calendar-check me-2"></i>Liste des Classes — {{ currentTabLabel }}
        </h5>
                ...
                <ul class="dropdown-menu shadow-sm dropdown-menu-end">
                  <li>
                    <a class="dropdown-item" href="#" @click.prevent="consulterNotes(classe)">
                      <i class="bi bi-eye me-2 text-muted"></i>Voir les examens
                    </a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="#" @click.prevent="ouvrirSaisieRapide(classe)">
                      <i class="bi bi-pencil me-2 text-muted"></i>Saisir les notes
                    </a>
                  </li>
