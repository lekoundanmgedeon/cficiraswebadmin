  ...
  <div class="container-fluid py-4 animate__animated animate__fadeIn">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
      <div>
        ...
        <p class="text-muted small mb-0">
          Génération des livrables réglementaires, statistiques de réussite et synthèses de performance par promotion.
        </p>
      </div>
    ...
    <div class="row g-4">
      <div class="col-lg-6">
        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
          <div class="card-header bg-white border-0 pt-4 px-4 pb-2">
            ...
            <p class="text-muted small mb-0">Documents certifiés conformes pour signature du jury.</p>
          </div>
            ...
            <div class="list-group list-group-flush">
              ...
              <div class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center border-bottom">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <small class="text-muted">Admissions, ajournements et classements officiels.</small>
                  </div>
                </div>
              ...
              <div class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center border-bottom">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="fw-bold text-dark mb-0">Rapport des Procès-Verbaux par EC/Matière</h6>
      ...
      <div class="col-lg-6">
        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
          <div class="card-header bg-white border-0 pt-4 px-4 pb-2">
            <h5 class="fw-bold text-dark mb-0">
              <i class="bi bi-graph-up-arrow text-primary me-2"></i>Statistiques & Graphiques de Session
            </h5>
            <p class="text-muted small mb-0">Indicateurs de performance destinés à la direction pédagogique.</p>
          </div>
          <div class="card-body px-4">
            <div class="list-group list-group-flush">
              ...
              <div class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center border-bottom">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <small class="text-muted">Distribution des mentions et pourcentages d'admis.</small>
                  </div>
                </div>
                <button class="btn btn-sm btn-light border" @click="genererRapport('STATS_REUSSITE')">
              ...
              <div class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center border-bottom">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="fw-bold text-dark mb-0">Bilan des Notes Éliminatoires & Défaillances</h6>
                    <small class="text-muted">Identification des matières à fort taux d'échec.</small>
                  </div>
                </div>
              ...
              <div class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center border-0">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <small class="text-muted">Extraction automatique des meilleurs profils par filière.</small>
                  </div>
                </div>
    ...
    <div class="col-12 mt-4">
      <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white">
        <div class="card-header bg-white border-0 pt-4 px-4 pb-2">
          <h5 class="fw-bold text-dark mb-0">
            <i class="bi bi-clock-history text-secondary me-2"></i>Historique récent des publications
          </h5>
        </div>
              ...
              <tbody>
                <tr v-for="log in mockLogs" :key="log.id">
                  ...
                  <td class="text-center">
                    <span class="badge rounded-pill bg-success bg-opacity-10 text-success px-3 py-1 small">
                      <i class="bi bi-cloud-check-fill me-1"></i> Scellé & Archivé
                    </span>
                  </td>
                  <td class="text-end pe-4">
                    <button class="btn btn-sm btn-link p-0 text-primary fw-bold" @click="telechargerFichierArchive(log.id)">
                      Récupérer
                    </button>
                  </td>
                </tr>
...
const mockLogs = ref([
  { id: 'R-901', docName: 'PV Semestre 1 - M1 Informatique', user: 'Admin Scolarité', date: '25/05/2026 14:32' },
  { id: 'R-902', docName: 'Rapport Statistiques Annuel - L3 Management', user: 'Secrétaire Jury', date: '24/05/2026 09:15' },
  { id: 'R-903', docName: 'Tableau d\'Honneur National - Bachelor', user: 'Direction Pédagogique', date: '22/05/2026 11:04' },
]);
