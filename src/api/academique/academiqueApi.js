...
export const getClassesOrganisationTree = () =>
  academiqueService.get('/classes/stats/organisations');
export const getGlobalInfrastructureKPIs = () =>
  academiqueService.get('/classes/analytics/dashboard-global');

export const getClassesByNiveau = (niveauId) =>
  academiqueService.get(`/classes/niveau/${niveauId}`);
export const getClassesByFiliere = (filiereId) =>
  academiqueService.get(`/classes/filiere/${filiereId}`);
...
export const assignModuleToClasse = (id, data) =>
  academiqueService.post(`/classes/${id}/assigner-module`, data);
export const getClasseOccupancyRate = (id) =>
  academiqueService.get(`/classes/${id}/taux-remplissage`);
...
export const getNiveauxByFiliere = (filiereId) =>
  academiqueService.get(`/niveaux/filiere/${filiereId}`);
...
export const changeSemestreStatus = (id, data) =>
  academiqueService.patch(`/semestres/${id}/statut`, data);
...
export const changeInscriptionStatus = (id, data) =>
  academiqueService.patch(`/inscriptions/${id}/statut`, data);
