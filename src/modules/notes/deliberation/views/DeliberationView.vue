...
/**
 * Délibération : bulletins d'une classe, décision du jury, publication.
 *
 ...
 *
 * L'onglet « Assistant IA » — une conversation aux messages codés en dur — a été
 * retiré : aucun backend ne l'alimente.
 *
...
<template>
  <div>
    <PageHeader
      title="Délibération"
      subtitle="Bulletins, décisions du jury et publication des résultats"
      :breadcrumb="['évaluations', 'délibération']"
    >
      <template #actions>
        <ExportMenu :disabled="classement.length === 0" @excel="exportToExcel" @pdf="exportToPdf" />
        <button
          class="btn btn-success btn-sm px-3 ms-2 mt-2 mt-xl-0"
