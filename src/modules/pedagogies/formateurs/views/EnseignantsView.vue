...
import FormateurHeader from '../components/FormateurHeader.vue';
import PedagogieTab from '../components/PedagogieTab.vue';
 ...
 * données n'avaient de rapport avec le contenu.
 *
 * Chaque onglet charge désormais ses propres données réelles : le squelette n'a
